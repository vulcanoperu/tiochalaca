...
module.exports = {
  // ── Interfaz estándar ──────────────────────────────────────────────────
  getFixtures:    getTodayFixtures,      // (date?, league?) → fixtures[]
  getLiveMatches: getLiveFixtures,        // () → liveFixtures[]
  getMatchDetail: getEnrichedSummary,     // (matchId) → enrichedData
  getTeamHistory: getTeamSchedule,        // (league, teamId) → events[]

  // ── Funciones específicas de ESPN (compatibilidad) ─────────────────────
  getTodayFixtures,
  getLiveFixtures,
  getMatchSummary,
  getEnrichedSummary,
